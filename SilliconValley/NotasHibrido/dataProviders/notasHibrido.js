...
(function() {
    var provider = app.data.notasHibrido = new Everlive({
            offlineStorage: true,
            appId: 'l3olb90oujzqeiyd',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'notasHibrido_access_token',
...
// START_CUSTOM_CODE_notasHibrido
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_notasHibrido